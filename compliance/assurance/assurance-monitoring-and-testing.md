...
Pour aider à mettre à l’échelle les efforts de simulation d’attaque, l’équipe rouge a créé un outil d’émulation d’attaque automatisée qui s’exécute en toute sécurité dans des environnements Microsoft 365 spécifiques sur une base récurrente. L’outil dispose d’un large éventail d’attaques prédéfines qui sont constamment étendues et améliorées afin de refléter l’évolution du paysage des menaces. En plus d’élargir la couverture des tests d’équipe rouge, elle permet à l’équipe bleue de valider et d’améliorer sa logique de surveillance de la sécurité. L’émulation régulière et continue des attaques fournit à l’équipe bleue un flux cohérent et divers de signaux qui sont comparés et validés par rapport aux réponses attendues. Cela permet d’améliorer la logique de Microsoft 365 sécurité et les fonctionnalités de réponse de l’Microsoft 365 de sécurité.

## <a name="blue-teams"></a>Bleu Teams
