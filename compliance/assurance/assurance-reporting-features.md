...
| [Recherche et conservation du contenu de boîte aux lettres](https://docs.microsoft.com/exchange/security-and-compliance/in-place-ediscovery/in-place-ediscovery) | Fournit des détails sur les modifications apportées aux paramètres de In-Place eDiscovery ou In-Place conservation sur les boîtes aux lettres. |
