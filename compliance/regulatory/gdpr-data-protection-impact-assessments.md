...
- [Windows](/compliance/regulatory/gdpr-dpia-windows): ce document s’applique à la [configuration du processeur données de diagnostic Windows](/windows/privacy/configure-windows-diagnostic-data-in-your-organization). Les clients sont encouragés à collaborer avec leurs responsables de la confidentialité et leur conseiller juridique pour déterminer la nécessité et le contenu d’une DPIA liée à leur utilisation de la configuration du processeur données de diagnostic Windows.
