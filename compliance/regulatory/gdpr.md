...
Le RGPD réglemente la collecte, le stockage, l’utilisation et le partage des « données personnelles ». Les données personnelles sont définies au sens large dans le RGPD comme étant l’ensemble de données qui concernent une personne physique identifiée ou identifiable.
