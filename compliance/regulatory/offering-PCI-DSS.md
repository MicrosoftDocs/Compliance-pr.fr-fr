...
## <a name="azure-dynamics-365-and-pci-dss"></a>Azure, Dynamics 365, et PCI DSS

Pour plus d’informations sur la conformité à Azure, Dynamics 365 et d’autres services en ligne, consultez [l’offre PCI DSS d’Azure ](/azure/compliance/offerings/offering-pci-dss).

## <a name="office-365-and-pci-dss"></a>Office 365 et PCI DSS
...
| **L’applicabilité** | **Services dans l’étendue** |
|:------------------|:----------------------|
| **Office 365** | OneDrive Entreprise (États-Unis uniquement) et SharePoint Online |

### <a name="office-365-audit-reports-and-certificates"></a>Audits, rapports et certificats d’Office 365

- [Attestation de conformité (AoC) PCI DSS de OneDrive Entreprise ainsi que de SharePoint Online ](https://aka.ms/spo-pci)
